...
////common revel option to create reveal animation////
ScrollReveal({
     reset: true,
     distance: '60px',
     duration: 2500,
...
///target element and any cify options ///
...
ScrollReveal().reveal('.skills-description, services-description, .contact-card', { delay: 700, origin:'left' });
